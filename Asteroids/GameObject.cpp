...
{
	this->world = world;
	circle = new sf::RectangleShape(sf::Vector2f(10,10));
	circle->setPosition(1080/2, -720/2);
	...
	this->shape->SetAsBox(this->circle->getSize().x * 0.5f - b2_polygonRadius, this->circle->getSize().y * 0.5f - b2_polygonRadius);
...
{
	texture->loadFromFile("Resources/" + file);
